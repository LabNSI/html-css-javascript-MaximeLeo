...
function resultat() {
  ...
  // on vérifie si deux des choix ont été cochés, si oui, on les ajoute au compteur
  for (var i=5; i < 12; i++)  {
  ...
  // on vérifie si le compteur est égal à 2,si c'est le cas, la personne a coché trop ou pas assez de spécialités
  if(cpt!=2){
    message += "\n- Deux spécialités";
  }

  // on vérifie si le message a été envoyé, si oui, on envoie le message et arrête la fonction
  ...
  // on vérifie si la spécialité NSI a été cochée
